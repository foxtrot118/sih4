...
const Color kPrimayLightColorLT = Color.fromARGB(255, 130, 176, 248);
const Color kPrimayColorLT = Color.fromARGB(255, 88, 151, 251);
  ...
  ThemeData buildLightTheme() {
    ...
    return systemLightTheme.copyWith(
        ...
        colorScheme: ColorScheme.fromSwatch(
            accentColor: kPrimayColorLT, primarySwatch: Colors.lightBlue));
  }
}
